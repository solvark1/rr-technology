...
/**
 * \file        htdocs/custom/verleih/admin/item_extrafields.php
 * \ingroup     verleih
 * \brief       Define extra attributes for VerleihItem
 */
...
$elementtype = 'verleih_item'; // Must match $table_element of VerleihItem
 ...
 * View
 */
$textobject = $langs->transnoentitiesnoconv("VerleihItem");
...
print load_fiche_titre($langs->trans("VerleihItem"), $linkback, 'fa-box');
