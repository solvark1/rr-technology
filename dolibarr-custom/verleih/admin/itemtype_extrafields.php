...
/**
 * \file        htdocs/custom/verleih/admin/itemtype_extrafields.php
 * \ingroup     verleih
 * \brief       Define extra attributes for VerleihItemType
 */
...
$elementtype = 'verleih_itemtype'; // Must match $table_element of VerleihItemType
 ...
 * View
 */
$textobject = $langs->transnoentitiesnoconv("VerleihItemType");
...
print load_fiche_titre($langs->trans("VerleihItemType"), $linkback, 'fa-tablet-alt');
