...
/**
 * \file        htdocs/custom/verleih/admin/schoolclass_extrafields.php
 * \ingroup     verleih
 * \brief       Define extra attributes for VerleihSchoolClass
 */
...
$elementtype = 'verleih_schoolclass'; // Must match $table_element of VerleihSchoolClass
 ...
 * View
 */
$textobject = $langs->transnoentitiesnoconv("VerleihSchoolClass");
...
print load_fiche_titre($langs->trans("VerleihSchoolClass"), $linkback, 'fa-users');
